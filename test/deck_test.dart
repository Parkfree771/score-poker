...
void main() {
  group('덱', () {
    test('표준 덱은 58장 (56 + 조커 2)', () {
      expect(Deck.standard().remaining, 58);
    });

    test('조커는 정확히 2장, 각 랭크는 4장씩', () {
      final all = Deck.standard().draw(100); // 58장 전부
    ...
    test('같은 seed면 셔플 결과가 재현된다', () {
      final a = Deck.shuffled(seed: 42).draw(58);
      final b = Deck.shuffled(seed: 42).draw(58);
      expect(a, b);
    });
