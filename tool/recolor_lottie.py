...
def recolor(src, dst, palette, glyph=None, tweak=None):
...
# 손패 조커 카드 문양: 원본 색 그대로(크림 카드 위 주황·노랑 광대 — 카드 팔레트 밖의 유일한 색)
recolor('wired-lineal-1451-card-joker-hover-pinch.json', 'joker_card.json', {})
